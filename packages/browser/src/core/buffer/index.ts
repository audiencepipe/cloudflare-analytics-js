...
import { CfEventsBrowserCore } from '../analytics/interfaces'
...
/**
 * The names of any CfEventsBrowser methods that also exist on Analytics
 */
...
export class AnalyticsBuffered
  implements PromiseLike<[Analytics, Context]>, CfEventsBrowserCore
{
  instance?: Analytics
  ctx?: Context
  ...
  group = this._createMethod('group') as CfEventsBrowserCore['group']
