...
describe('Analytics', () => {
  ...
  describe('reset', () => {
    ...
    it('clears user and group data', async () => {
      ...
      expect(storedData).toEqual({
        cfjs_user_id: 'known-user',
        cfjs_anonymous_id: 'unknown-user',
        cfjs_group_id: 'known-group',
        cfjs_user_traits: {
          job: 'engineer',
        },
  ...
  describe('storage', () => {
    ...
    it('handles custom priority storage', async () => {
      ...
      localStorage.setItem('cfjs_anonymous_id', 'localStorageValue')
    ...
    it('handles disabling storage', async () => {
      ...
      expect(localStorage.getItem('cfjs_anonymous_id')).toBe(
        'localStorageValue'
      )
    })
  })
