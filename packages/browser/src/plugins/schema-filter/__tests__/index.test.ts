  ...
  remotePlugins: [
    {
      ...
      url: 'https://cdn.cloudflare-events.com/next-integrations/actions/braze/9850d2cc8308a89db62a.js',
      settings: {
        subscriptions: [
          {
    ...
    },
    {
      ...
      url: 'https://cdn.cloudflare-events.com/next-integrations/actions/fullstory/35ea1d304f85f3306f48.js',
      settings: {
        subscriptions: [
          {
            partnerAction: 'trackEvent',
...
describe('schema filter', () => {
  ...
  beforeEach(async () => {
    ...
    jest.spyOn(cloudflarePlugin, 'track')
  ...
  describe('plugins and destinations', () => {
    ...
    it('does not drop events when no plan is defined', async () => {
      ...
      expect(cloudflarePlugin.track).toHaveBeenCalled()
