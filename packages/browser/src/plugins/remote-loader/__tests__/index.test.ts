        ...
        remotePlugins: [
          {
            name: 'remote plugin',
            creationName: 'remote plugin',
            url: 'https://cdn.cloudflare-events.cloudflare.com/actions/file.js',
            libraryName: 'testPlugin',
            settings: {},
          },
        ],
        ...
        remotePlugins: [
          {
            ...
            url: 'https://cdn.cloudflare-events.cloudflare.com/next-integrations/actions/braze/a6f95f5869852b848386.js',
            settings: {
