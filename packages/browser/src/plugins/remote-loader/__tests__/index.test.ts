...
describe('Remote Loader', () => {
        ...
        remotePlugins: [
          {
            name: 'remote plugin',
            creationName: 'remote plugin',
            url: 'https://cdn.hightouch-events.cloudflare.com/actions/file.js',
            libraryName: 'testPlugin',
            settings: {},
          },
        ],
  ...
  it('should work if the cdn is staging', async () => {
    const stagingURL = 'https://cdn.hightouch-events.cloudflare.com/actions/foo.js'
        ...
        remotePlugins: [
          {
            ...
            url: 'https://cdn.hightouch-events.cloudflare.com/next-integrations/actions/braze/a6f95f5869852b848386.js',
            settings: {
